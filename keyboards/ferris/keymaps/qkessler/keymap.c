...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_QUOT, TD(DANCE_2), TD(DANCE_1), KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, KC_A, KC_O, MT(MOD_LALT,KC_E), MT(MOD_LGUI,KC_U), KC_I, KC_D, MT(MOD_RGUI,KC_H), MT(MOD_RALT,KC_T), KC_N, KC_S, KC_SCLN, KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, CTL_T(KC_ESC), LSFT_T(KC_BSPC), MT(MOD_MEH, KC_SPACE), TO(1)),
	[1] = LAYOUT(KC_EXLM, KC_AT, LSFT(KC_3), TD(DANCE_31), KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_SCLN, KC_SLSH, KC_TAB, KC_EQL, LALT(KC_RBRACKET), LALT(LSFT(KC_RBRACKET)), TD(DANCE_32), TD(BKSL_HME), LSFT(KC_LBRC), LSFT(KC_RBRC), TD(PIPE_END), KC_ENT, KC_TILD, TD(DANCE_33), LALT(KC_LBRACKET), LALT(LSFT(KC_LBRACKET)), KC_DQUO, KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC, TO(3), TO(0), LSFT_T(KC_BSPC), RALT_T(KC_SPC), TO(2)),
	[2] = LAYOUT(KC_ESC, KC_MPLY, KC_MPRV, KC_MNXT, LSFT(KC_MINS), KC_MINS, KC_7, KC_8, KC_9, KC_TRNS, KC_TAB, KC_TRNS, KC_VOLD, KC_VOLU, LSFT(KC_EQL), KC_EQL, KC_4, KC_5, KC_6, KC_ENT, RESET, KC_PAST, KC_BRID, KC_BRIU, KC_PDOT, KC_0, KC_1, KC_2, KC_3, KC_TRNS, TO(0), LSFT_T(KC_BSPC), RALT_T(KC_SPC), KC_TRNS),
