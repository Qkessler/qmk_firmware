...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
                 ...
                 KC_A, KC_S, LALT_D, LGUI_F, KC_G, KC_H, RGUI_J, RALT_K, KC_L, KC_SCLN,
                 KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, TD(DANCE_2), TD(DANCE_1), KC_SLSH,
                 CTL_T(KC_ESC), LSFT_T(KC_BSPC),         MT(MOD_MEH, KC_SPACE), TO(1)),
	[1] = LAYOUT(KC_EXLM, KC_AT, LSFT(KC_3), TD(DANCE_31), KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_SCLN, KC_SLSH,
                 KC_TAB, KC_EQL, LALT(KC_RBRACKET), LALT(LSFT(KC_RBRACKET)), TD(DANCE_32), TD(BKSL_HME), LSFT(KC_LBRC), LSFT(KC_RBRC), TD(PIPE_END), KC_ENT,
                 KC_TILD, TD(DANCE_33), LALT(KC_LBRACKET), LALT(LSFT(KC_LBRACKET)), KC_DQUO, KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC,
                 TO(3), TO(0), LSFT_T(KC_BSPC), RALT_T(KC_SPC), TO(2)),
